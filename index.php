...
<head>
	...
	<!-- Favicon -->
	<link rel="apple-touch-icon" sizes="180x180" href="./images-map/favicon/apple-touch-icon.png">
	<link rel="icon" type="image/png" sizes="32x32" href="./images-map/favicon/favicon-32x32.png">
	<link rel="icon" type="image/png" sizes="192x192" href="./images-map/favicon/android-chrome-192x192.png">
	<link rel="icon" type="image/png" sizes="16x16" href="./images-map/favicon/favicon-16x16.png">
	<link rel="manifest" href="./images-map/favicon/site.webmanifest">
	<link rel="mask-icon" href="./images-map/favicon/safari-pinned-tab.svg" color="#e2b055">
	<link rel="shortcut icon" href="./images-map/favicon/favicon.ico">
	<meta name="msapplication-TileColor" content="#131313">
	<meta name="msapplication-TileImage" content="./images-map/favicon/mstile-144x144.png">
	<meta name="msapplication-config" content="./images-map/favicon/browserconfig.xml">
	...
	<!-- Map Styles -->
	<link href="./style.css?v=<?= $g->getSettings('site-version') ?>" rel="stylesheet">
	...
	<link href="src/leaflet.awesome-markers.css?v=<?= $g->getSettings('site-version') ?>" rel="stylesheet" type="text/css">
